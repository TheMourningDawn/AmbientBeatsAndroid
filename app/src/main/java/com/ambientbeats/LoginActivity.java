    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if(devices.size() > 0) {
                ...
                Toaster.s(LoginActivity.this, "Logged in!");
                return true;
            } else {
                Toaster.s(LoginActivity.this, "No devices linked to your account! Please add one!");
                Log.e("NoDevices", "Couldn't find any devices for your account");
            }
